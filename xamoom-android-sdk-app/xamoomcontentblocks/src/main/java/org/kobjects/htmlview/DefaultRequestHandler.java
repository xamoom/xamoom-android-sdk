...
public class DefaultRequestHandler implements RequestHandler {
  ...
  public void openLink(HtmlView htmlView, Element a, URI href) {
    ...
    Log.v("pingeborg.xamoom.com", "HELLYEAH");
    Intent browserIntent = new Intent(ACTION_VIEW, Uri.parse(HtmlUtils.toString(href)));
    htmlView.getContext().startActivity(browserIntent);
  }
