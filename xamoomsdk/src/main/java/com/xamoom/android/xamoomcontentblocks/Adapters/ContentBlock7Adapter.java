...
public class ContentBlock7Adapter implements AdapterDelegate<List<ContentBlock>> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(
          ...
          XamoomContentFragment.OnXamoomContentFragmentInteractionListener onXamoomContentFragmentInteractionListene, @Nullable ArrayList<String> urls, @Nullable ArrayList<String> nonUrls,
