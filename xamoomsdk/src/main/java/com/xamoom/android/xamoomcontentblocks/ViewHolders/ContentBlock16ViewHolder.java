...
public class ContentBlock16ViewHolder extends RecyclerView.ViewHolder {
    ...
    private final EnduserApi mEnduserApi;
    private final SharedPreferences sharedPreferences;
    private final Context context;

    private final OnContentBlock16ViewHolderInteractionListener mListener;
    private final XamoomContentFragment.OnXamoomContentFragmentInteractionListener onQuizResponseListener;
    ...
    public ContentBlock16ViewHolder(View itemView, EnduserApi enduserApi, Context context,
                                    OnContentBlock16ViewHolderInteractionListener onContentBlock16ViewHolderInteractionListener, XamoomContentFragment.OnXamoomContentFragmentInteractionListener onXamoomContentFragmentInteractionListener) {
        super(itemView);
        this.mListener = onContentBlock16ViewHolderInteractionListener;
    ...
    private void setWebViewSettings() {
        ...
        formWebView.addJavascriptInterface(new ShowHtmlJavaScriptInterface16(onQuizResponseListener), "HTMLOUT");
    ...
    public interface OnContentBlock16ViewHolderInteractionListener {
...
class ShowHtmlJavaScriptInterface16 {

    private XamoomContentFragment.OnXamoomContentFragmentInteractionListener onQuizResponseListener;

    public ShowHtmlJavaScriptInterface16(XamoomContentFragment.OnXamoomContentFragmentInteractionListener onQuizResponseListener) {
