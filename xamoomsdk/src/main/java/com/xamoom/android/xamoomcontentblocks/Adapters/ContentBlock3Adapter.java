...
public class ContentBlock3Adapter implements AdapterDelegate<List<ContentBlock>> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(
    ...
    return new ContentBlock3ViewHolder(view, fragment.getContext(), onContentBlock3ViewHolderInteractionListener, urls, nonUrls, fragment, onXamoomContentFragmentInteractionListener);
  }
