...
public class ContentBlock4Adapter implements AdapterDelegate<List<ContentBlock>> {
  private static final int BLOCK_TYPE = 4;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(
    ...
    return new ContentBlock4ViewHolder(view, fragment, urls, nonUrls);
  }
  ...
  public void onBindViewHolder(@NonNull List<ContentBlock> items, int position,
    ...
    ContentBlock cb = items.get(position);
    ContentBlock4ViewHolder newHolder = (ContentBlock4ViewHolder) holder;
